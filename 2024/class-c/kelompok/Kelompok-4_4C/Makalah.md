...
- Lalu kasus berikutnya terjadi pada <i>Toronto Public Library (TPL)</i>, yang terjadi pada tanggal 28 November 2023 lalu. Serangan ransomware menjadi penyebab gangguan layanan selama lebih dari seminggu di perpustakaan umum Toronto. Peretas mencuri sejumlah besar data pribadi staff dan berkas, termasuk nama, nomor insuran sosial dan alamat rumah mereka, serta salinan kartu identitas diri. Perpustakaan menolak membayar tebusan yang dilaporkan mencapai sepuluh juta dolar US dan memilih untuk membangun ulang seluruh infrastruktur sistem dari awal. Proses pemulihan berlansung hampir lima bulan.
- Pada tanggal 28 Oktober 2023, <i>British Library</i> telah terkena serangan ransomware yang membahayakan sebagian besar sistem daringnya. Serangan tersebut, yang dikalim oleh ransomware Rhysida, mengekstrak data, mengenkripsi atau menghancurkan sebagian sebar server perpustakaan, dan secara paksa memblokir akses semua pengguna ke jaringan.
- Pada tanggal 20 Juni 2024, Indonesia digemparkan dengan insiden kebocoran data yang melibatkan Pusat Data Nasional Sementara (PDNS). Dimana pada serangan siber yang kali ini berakibat fatal pada sebagian besar sistem informasi dan instansi yang berada didalamnya. Sebanyak lebih dari 210 instansi pemerintah mengalami <i>down</i> pada layanan publik mereka terutama pada sektor imigrasi.
<p align="justify">
